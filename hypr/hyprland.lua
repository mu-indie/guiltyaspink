...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("/home/bess/.config/rofi/powermenu/type-2/powermenu.sh"))
...
hl.bind(
	mainMod .. " + V",
	hl.dsp.exec_cmd(
		"cliphist list | rofi -dmenu -display-columns 2 -p 'Search Clipboard' -theme .local/share/rofi/themes/rounded-nord-dark.rasi | cliphist decode | wl-copy"
	)
)
